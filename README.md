...
Stellar Burger — это концепт веб‑приложения для сборки и заказа персонализированных бургеров. Проект демонстрирует современный UI/UX с футуристической эстетикой: тёмная тема, неоновые акценты, стилизованные карточки ингредиентов и интуитивная логика конструктора.
